...
public class DriveIOSpark implements DriveIO {
  ...
  private final SparkMax leftFollower = new SparkMax(leftFollowerCanId, MotorType.kBrushed);
  private final SparkMax rightFollower = new SparkMax(rightFollowerCanId, MotorType.kBrushed);
